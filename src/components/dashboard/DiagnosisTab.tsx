             ...
             <label htmlFor="image-upload" className="cursor-pointer">
                {imagePreview ? (
                    <div className="relative w-full h-64">
                         ...
                         <Button variant="destructive" size="icon" className="absolute top-2 right-2 z-10 h-8 w-8" onClick={(e) => { e.preventDefault(); setImagePreview(null); setImageFile(null); setDiagnosis(null); }}>
                             <X className="h-4 w-4"/>
                         </Button>
                    </div>
                ) : (
      ...
      <div className="space-y-8">
        <Card className="shadow-lg border-primary/20">
            <CardHeader>
                ...
                <CardDescription>Ask a question using your voice in your local dialect.</CardDescription>
            </CardHeader>
